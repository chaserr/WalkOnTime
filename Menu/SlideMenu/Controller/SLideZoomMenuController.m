...
- (void)addmenuItem
{
    ...
    if ([self.rootViewController isKindOfClass:[TXNavigationController class]]) {
        TXNavigationController *nav = (TXNavigationController *)self.rootViewController;
    ...
    UIBarButtonItem *barItem = [UIBarButtonItem itemWithIcon:@"menu" highIcon:nil target:self action:@selector(showLeft)];
